...
def main(args):
    ...
    print(args)
    args_dict = vars(args)
    args_dict['num_eval_samples'] = str(args_dict['num_eval_samples'])
    aim_run['args'] = vars(args)
    ...
    # )
    logging.info('Finished AIM init.')
    ...
    for dataset_split in ['train', 'validation']:
        ...
        utils.save(generations, f'{dataset_split}_generations.pkl', aim_run)

        # Log overall accuracy.
        accuracy = np.mean(accuracies)
        print(f"Overall {dataset_split} split accuracy: {accuracy}")
        #wandb.log({f"{dataset_split}_accuracy": accuracy})
        aim_run.track(accuracy, name=f"{dataset_split}_accuracy")
        ...
        if dataset_split == 'validation':
            ...
            utils.save(results_dict, 'uncertainty_measures.pkl', aim_run)

    utils.save(experiment_details, 'experiment_details.pkl', aim_run)
...
if __name__ == '__main__':
    ...
    if args.compute_uncertainties:
        ...
        main_compute(args, aim_run_hash=aim_run_hash)
